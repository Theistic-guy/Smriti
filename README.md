# Smriti — A Gentle Shloka Reminder While You Work
...
Minimizing it keeps Smriti running.
...
* Reference numbers should use dots instead of spaces
  Example: `bg.2.47` (not `bg 2 47`)
